...
namespace NominaMensual
{
    public partial class Empleado : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            op.ConsultasinResultado("INSERT INTO empleados(cedula, nombre, apellido, direccion, sexo, sueldo, fecha_nacimiento, fecha_ingreso, cod_cargo, nombre_cargo) VALUES('" + txt7.Text + "', '" + txt1.Text + "', '" + txt2.Text + "', '" + txt3.Text + "', '" + txt4.Text + "', '" + txt5.Text + "', '" + dateTimePicker1.Text + "','" + dateTimePicker3.Text + "', '" + txtCargo.Text + "','" + txtnombre_cargo.Text + "')");
        ...
        private void empleado_Load(object sender, EventArgs e)
        {
            ...
            txtCargo.Text = xcod_cargo;
            txtCargo.Text = xnombre_cargo;
        ...
        private void btnUp_Click(object sender, EventArgs e)
        {
            ...
            Operaciones op = new Operaciones();
            op.ConsultasinResultado("UPDATE empleados SET cedula = '" + txt7.Text + "', nombre = '" + txt1.Text + "', apellido = '" + txt2.Text + "', direccion = '" + txt3.Text + "' sexo = '" + txt4.Text + "' sueldo = '" + txt5.Text + "' fecha_nacimiento = '" + dateTimePicker1.Text + "' fecha_ingreso = '" + dateTimePicker3.Text + "' cod_cargo = '" + txtCargo.Text + "' nombre_cargo = '" + txtnombre_cargo.Text + ""); //' WHERE cod_empleado LIKE ' %" + txtCodigo.ToString() + "%' ");
        ...
        private void btnCargoEM_Click(object sender, EventArgs e)
        {
            //Lamado al formulario Cargos//
